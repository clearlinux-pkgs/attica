...
Source0  : https://download.kde.org/stable/frameworks/5.73/attica-5.73.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.73/attica-5.73.0.tar.xz.sig
...
%prep
%setup -q -n attica-5.73.0
cd %{_builddir}/attica-5.73.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597695119
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/attica-5.73.0/COPYING %{buildroot}/usr/share/package-licenses/attica/912d84655bc9049b536f72c7001aeeab85a77521
cp %{_builddir}/attica-5.73.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/attica/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Attica.so.5.73.0
