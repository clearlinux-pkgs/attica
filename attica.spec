...
Source0  : https://download.kde.org/stable/frameworks/5.65/attica-5.65.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.65/attica-5.65.0.tar.xz.sig
...
%prep
%setup -q -n attica-5.65.0
cd %{_builddir}/attica-5.65.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576508663
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/attica-5.65.0/COPYING %{buildroot}/usr/share/package-licenses/attica/912d84655bc9049b536f72c7001aeeab85a77521
cp %{_builddir}/attica-5.65.0/src/license.cpp %{buildroot}/usr/share/package-licenses/attica/46ec506c5e90e1aefe9ab5f7c6e8265bf099eac2
cp %{_builddir}/attica-5.65.0/src/license.h %{buildroot}/usr/share/package-licenses/attica/c6647cb1b49ecff1f14778a2018a3131a44b51b3
cp %{_builddir}/attica-5.65.0/src/licenseparser.cpp %{buildroot}/usr/share/package-licenses/attica/ed09c2b0a3204852dc8cf88f795f499e065c4652
cp %{_builddir}/attica-5.65.0/src/licenseparser.h %{buildroot}/usr/share/package-licenses/attica/c647bc8b4f65971eb638f6cec96cd2dfe7a80789
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Attica.so.5.65.0
